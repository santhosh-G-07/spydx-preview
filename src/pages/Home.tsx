    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <Button asChild size="lg" className="bg-gradient-cyan text-primary-foreground font-semibold hover:opacity-90 shadow-cyan">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Button asChild size="lg" className="bg-gradient-cyan text-primary-foreground font-semibold shadow-cyan">
      ...
      <SectionWrapper>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-card rounded-2xl p-1 border border-border shadow-card">
            <img
              src="https://thespydx.com/img/info.jpg"
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {techStack.map((tech, i) => (
            <motion.span
              ...
              className="px-5 py-2.5 rounded-full bg-secondary text-sm font-medium text-muted-foreground border border-border hover:border-primary/30 hover:text-primary transition-all cursor-default"
            >
              {tech}
            </motion.span>
          ))}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            <Button type="submit" className="bg-gradient-cyan text-primary-foreground font-semibold">
              Subscribe
            </Button>
          </form>
